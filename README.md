...
## Build Status
* Master | Arduino IDE 1.8.5 | ESP8266 Arduino 2.4.0 | latest libraries | Thermostat confid: [![Build Status](https://travis-ci.org/eXtatic-GitHub/ESP8266.svg?branch=master)](https://travis-ci.org/eXtatic-GitHub/ESP8266)
